...
const AlertaP = ({alertap}) =>{

    return(
        <div className={`${alertap.error ?' bg-red-400   ' : 'bg-green-500'}  flex rounded-lg p-1 mb-2 text-sm role="alert" ' `}>
        ...
        <div>
            <h2 className=" text-white font-nunito text-base font-semibold"><span className="font-bold font-nunito"> </span> {alertap.msgp} </h2>
        </div>
    </div>
    )
}
