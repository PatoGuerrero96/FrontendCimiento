...
<div >
    ...
    ?
<div className="">
<div className="text-lila-300 title text-sm font-semibold font-nunito">Usted es fumador?</div>
...
<div className='p-1'> 
   <button className="    bg-lila-200 px-2 py-2 text-xs text-white rounded-md text-center  font-nunito  hover:bg-indigo-400  ">Guardar</button>
    ...
    <div className=' text-sm'>
      ...
      <div className='px-1 mt-1  font-nunito'> { auth.historiaclinica?.fumador==='Si' ? 
    
      <div className=''>
       <h1 className='font-bold '> Tabaquismo: </h1>
       <span className=' font-bold text-green-700'> Si fuma</span>
       <div className='flex justify-center'>  <span className='text-2xl'>🚬</span></div>
       </div>
      :
      <div className=''>
      <h1 className='font-bold '> Tabaquismo: </h1>
      <span className=' font-bold text-green-700'> No fuma</span>
      <div className='flex justify-center'>  <span className='text-2xl'>🚭</span></div>
      </div>} </div>    
      </div>
