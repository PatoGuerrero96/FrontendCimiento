...
<div className="text-lila-300 title text-sm font-semibold font-nunito">Usted realiza actividad física?</div>
<div className="w-full ">

  <form onSubmit={handleSubmit} >
    <div  className='flex justify-center '>
<div className="inline-block mr-1 mt-1 text-sm">
      <div className="flex">
      <div>
...
<div className='p-1'> 
   <button className=" bg-lila-200 px-2 py-2 text-xs text-white rounded-md text-center  font-nunito  hover:bg-indigo-400  ">Guardar</button>
    ...
    <div className='text-sm'>
      <div className='bg-white text-sm border-gray-200 rounded-lg text-center'>
      <h1 className='px-1 mt-1  font-nunito'> { auth.historiaclinica?.actividadfisica==='Si' ? 
       <div className=''>
       <h1 className='font-bold '> Actividad fisica: </h1>
       <span className=' font-bold text-green-700'> Si realiza </span>
       <div className='flex justify-center'>  <span className='text-2xl'>🚴‍♀️</span></div>
       </div>
      :
      <div className=''>
      <h1 className='font-bold '> Actividad fisica: </h1>
      <span className=' font-bold text-green-700'> No realiza </span>
