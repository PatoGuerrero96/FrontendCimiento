  ...
  <div className='p-1'> 
   <button className="   bg-lila-200 px-2 py-2 text-xs text-white rounded-md text-center  font-nunito  hover:bg-indigo-400 ">Guardar</button>
    ...
    <div>
      ...
      :''} </div>
       <div className='px-1 mt-1 text-xs  font-nunito'>    { auth.historiaclinica?.alimentacion==='2' ? 
      <div className=''>
      <h1 className='font-bold '>Calidad de la alimentación: </h1>
      <span className=' font-bold text-coral-200'> Muy negativa</span>
      <div className='flex justify-center'>  <span className='text-2xl'> 🤢</span></div>
      </div>
      :''} </div> 
       <div className='px-1 mt-1 text-xs  font-nunito'>    { auth.historiaclinica?.alimentacion==='3' ? 
            <div className=''>
            <h1 className='font-bold '>Calidad de la alimentación: </h1>
      ...
      :''} </div> 
       <div className='px-1 mt-1  text-xs  font-nunito'>    { auth.historiaclinica?.alimentacion==='4' ? 
                   <div className=''>
                   <h1 className='font-bold '>Calidad de la alimentación: </h1>
      ...
      :''} </div> 
       <div className='px-1 mt-1 text-xs  font-nunito'>    { auth.historiaclinica?.alimentacion==='5' ? 
        <div className=''>
        <h1 className='font-bold '> Calidad de la alimentación:</h1>
      ...
      :''} </div> 
       <div className='px-1 mt-1 text-xs  font-nunito'>    { auth.historiaclinica?.alimentacion==='6' ? 
          <div className=''>
          <h1 className='font-bold '>Calidad de la alimentación: </h1>
      ...
      :''} </div>
       <div className='px-1 mt-1 text-xs  font-nunito'>    { auth.historiaclinica?.alimentacion==='7' ? 
                <div className=''>
                <h1 className='font-bold '> Calidad de la alimentación: </h1>
      ...
      :''} </div>   
       <div className='px-1 mt-1 text-xs  font-nunito'>    { auth.historiaclinica?.alimentacion==='8' ? 
                <div className=''>
                <h1 className='font-bold '> Calidad de la alimentación: </h1>
      ...
      :''} </div>   
       <div className='px-1 mt-1 text-xs  font-nunito'>    { auth.historiaclinica?.alimentacion==='9' ? 
       <div className=''>
       <h1 className='font-bold '> Calidad de la alimentación: </h1>
      ...
      :''} </div>   
       <div className='px-1 mt-1 text-xs   font-nunito'>    { auth.historiaclinica?.alimentacion==='10' ? 
          <div className=''>
          <h1 className='font-bold '> Calidad de la alimentación: </h1>
