...
<div >
    ...
    ?
<div className="">
<div className="text-lila-300 title text-sm font-semibold font-nunito">¿Usted consume drogas?</div>
...
<div className='p-1'> 
   <button className="   bg-lila-200 px-2 py-2 text-xs text-white rounded-md text-center  font-nunito  hover:bg-indigo-400 ">Guardar</button>
    ...
    <div className='text-sm'>
      ...
      <h1 className='px-1 mt-1  font-nunito'> { auth.historiaclinica?.drogas==='Si' ?
        <div className=''>
        <h1 className='font-bold '> Drogas: </h1>
