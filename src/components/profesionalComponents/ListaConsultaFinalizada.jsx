...
const ListaConsultaFinalizada = () => {
    ...
    const consultaspro =  consultas.filter(con => con.profesional._id === authpro._id &&con.estado ==='finalizado') 
    return (
    <> 
    <HeaderConsultasPro/>
  ...
  <Link to={`/profesional/consulta/${consulta._id}`} className="bg-green-600 hover:bg-green-500 text-white text-sm font-nunito font-semibold mr-1 py-1 px-2 rounded">
    Ver más
  </Link >
</td>
...
export default ListaConsultaFinalizada