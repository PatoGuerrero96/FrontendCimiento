...
const ListaConsultaRechazada = () => {
    ...
    const consultaspro =  consultas.filter(con => con.profesional._id === authpro._id &&con.estado ==='rechazada') 
    return (
    <> 
    <HeaderConsultasPro/>
  ...
  <div className="container mx-auto shadow-lg mt-1">
    <div className="-mx-4 flex flex-wrap">
      ...
      <div className="flex justify-center py-10  ">
        ...
        <h1 className="text-2xl text-white">Aún no tienes Consultas Rechazadas</h1>
        </div>
...
export default ListaConsultaRechazada