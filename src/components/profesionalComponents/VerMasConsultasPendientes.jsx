...
const VerMasConsultasPendientes= () => {
...
<div className="text-center px-4 py-4  bg-yellow-200 max-w-xl rounded-full">
  <h1 className="text-xl font-semibold text-yellow-600 ">Consulta Pendiente</h1>
</div>
</div>
...
export default VerMasConsultasPendientes