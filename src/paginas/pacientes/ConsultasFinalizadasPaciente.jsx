...
const ConsultasFinalizadasPaciente  = () => {
    ...
    const consultaspaciente =  consultas.filter(con => con.paciente._id === auth._id &&con.estado ==='finalizado') 
  ...
  <Link  to={`/paciente/vermas-consulta-aprobada/${consulta._id}`} className="bg-green-600 hover:bg-green-700 text-white text-sm font-nunito font-semibold mr-1 py-1 px-2 rounded">
    Ver más
  </Link>
</td>
  ...
  <div className="flex justify-center">
    <Link to={`/paciente/vermas-consulta-aprobada/${consulta._id}`} className="bg-green-600 hover:bg-green-700 text-white text-sm font-nunito font-semibold mr-1 py-1 px-2 rounded">
      ...
      <div className="flex justify-center py-10  ">
        ...
        <h1 className="text-2xl text-white">Aún no tienes Consultas Finalizadas</h1>
        </div>
...
export default ConsultasFinalizadasPaciente 