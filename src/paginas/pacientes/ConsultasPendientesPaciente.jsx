...
const ConsultasPendientesPaciente = () => {
    ...
    const consultaspaciente =  consultas.filter(con => con.paciente._id === auth._id &&con.estado ==='pendiente') 
  ...
  <Link  to={`/paciente/vermas-consulta/${consulta._id}`} className="bg-yellow-500 hover:bg-yellow-400 text-white text-sm font-nunito font-semibold mr-1 py-1 px-2 rounded">
    Ver más
  </Link>
</td>
...
export default ConsultasPendientesPaciente