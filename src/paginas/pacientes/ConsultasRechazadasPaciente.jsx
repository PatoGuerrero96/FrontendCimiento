...
const ConsultasRechazadasPaciente = () => {
    ...
    const consultaspaciente =  consultas.filter(con => con.paciente._id === auth._id &&con.estado ==='rechazada') 
...
export default ConsultasRechazadasPaciente 