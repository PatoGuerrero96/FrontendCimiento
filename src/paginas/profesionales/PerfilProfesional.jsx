...
<div className="">
            ...
            <div className="flex justify-center -full">
                ...
                <label className="block mb-2 text-sm font-bold text-gray-900 font-nunito dark:text-white" >Sube tu foto de perfil</label>
                    ...
                    <button type="submit" className=" text-sm text-white bg-lila-300 py-2 px-4 rounded-md mt-1 hover:bg-lila-100">Subir foto</button>
                   </form>
        ...
        <div className="mt-2 text-center">
            ...
            <h3 className=" text-2xl font-semibold font-nunito text-lila-300 dark:text-gray-300"> {authpro.nombres} {authpro.apellidos} </h3>
            ...
            <div className=" flex items-center border-2 mb-10 py-2 px-3 rounded-2xl">
                ...
                className=" dark:bg-slate-300 font-normal text-sm  font-nunito  pl-2 w-full outline-none border-none"
                 type="text"
                  ...
                  <button  className="text-sm text-gray-100 bg-lila-300 hover:bg-lila-200 pt-1 pb-1 pl-2 pr-2 rounded-lg ">
